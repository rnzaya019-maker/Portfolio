    ...
    <footer id="contact" className="bg-steppe-text py-20 px-6 text-steppe-bg relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="flex justify-center mb-8">
          <img src="/assets/Parcovo.png" alt="Parcovo mascot" className="h-24 w-auto opacity-90" />
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
          ...
          >
            ...
            <span className="font-sans tracking-wide font-bold">rn.zaya019@gmail.com</span>
          </a>
          ...
          >
            ...
            <span className="font-sans tracking-wide font-bold">LinkedIn Profile</span>
          </a>
          ...
          >
            ...
            <span className="font-sans tracking-wide font-bold">GitHub Profile</span>
          </a>
        </div>
